...
export default function ResourcesPage() {
  ...
  return (
    ...
    <div className="min-h-screen bg-[#f8f7ff]">
      ...
      <section className="container mx-auto py-12">
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-8">
          <div className="relative flex-1">
            ...
            <Input placeholder="Search resources..." className="pl-10 bg-white border-gray-200" />
          </div>
      ...
      {/* Featured Resources */}
      <section className="container mx-auto py-12">
        <div className="bg-gradient-to-r from-[#eae6ff] to-[#e1f0ff] rounded-2xl p-8">
          <h2 className="text-2xl font-bold mb-6">Featured Resources</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white rounded-xl p-6 flex items-center gap-4">
              <div className="bg-[#f0edff] p-3 rounded-lg">
                <svg
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Comprehensive overview of your learning journey</p>
              </div>
            </div>
            <div className="bg-white rounded-xl p-6 flex items-center gap-4">
              <div className="bg-[#e1f0ff] p-3 rounded-lg">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Step-by-step learning experiences</p>
              </div>
            </div>
          </div>
        </div>
  ...
  return (
    <Card className="overflow-hidden hover:shadow-md transition-shadow">
      {/* <div className="relative h-40">
        ...
        <Badge className="absolute top-3 right-3 bg-white text-gray-700">{type}</Badge>
      </div> */}
      <CardHeader className="pb-2">
        <CardTitle className="text-lg">{title}</CardTitle>
      </CardHeader>
      <CardContent className="pb-2">
        <Badge variant="outline" className="bg-[#f0edff] text-[#8a7cff] border-[#8a7cff]">
          {category}
        </Badge>
      </CardContent>
      <CardFooter className="flex justify-between pt-0">
        <Button variant="ghost" size="sm" className="text-gray-500 hover:text-[#8a7cff]">
          <Eye className="h-4 w-4 mr-1" />
          View
        </Button>
        <div className="flex gap-1">
          <Button variant="ghost" size="icon" className="h-8 w-8 text-gray-500 hover:text-[#8a7cff]">
