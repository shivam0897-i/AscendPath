...
const Home = () => {
  ...
  return (
    // Wrap the existing top-level div with motion.div
    <motion.div
      initial="initial"
      animate="in"
      exit="out"
      ...
      className="min-h-screen flex flex-col" // Added flex flex-col
    >
      <Navbar />

      {/* Ensure main content takes remaining space */}
      <main className="flex-grow"> 
        {/* KEEP ALL EXISTING PAGE CONTENT AND STRUCTURE */}
        {/* Hero Section */}
